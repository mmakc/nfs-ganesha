...
/* we pass in attributes to the create.  We will get them back below */
    ...
    switch (type) {
    case REGULAR_FILE:
            fsal_status = dir_handle->ops->create(req_ctx, dir_handle,
                                                  name,
                                                  &object_attributes,
                                                  &object_handle);
            break;
    ...
    case DIRECTORY:
            fsal_status = dir_handle->ops->mkdir(req_ctx, dir_handle,
                                                 name,
                                                 &object_attributes,
                                                 &object_handle);
            break;
    ...
    case SYMBOLIC_LINK:
            fsal_status = dir_handle->ops->symlink(req_ctx, dir_handle,
                                                   name,
        ...
        case SOCKET_FILE:
        case FIFO_FILE:
            fsal_status = dir_handle->ops->mknode(req_ctx, dir_handle,
                                                  name,
                                                  type,
